...
export function SelectTrigger({ children }: SelectTriggerProps) {
  ...
  return (
    <button
      ...
      className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-700 flex items-center justify-between hover:border-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-500"
    >
      {children}
