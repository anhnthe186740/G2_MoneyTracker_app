      ...
      <div className="bg-white dark:bg-slate-900 rounded-lg shadow-xl p-6 w-full max-w-md border border-border dark:border-slate-800">
        <div className="flex justify-between items-center mb-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl font-bold text-foreground">{t('quickCreate.title')}</h2>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="block text-sm font-medium mb-2 text-foreground">{t('quickCreate.nameLabel')}</label>
            <input
              type="text"
              value={formData.name}
          ...
          <div>
            <label className="block text-sm font-medium mb-2 text-foreground">{t('quickCreate.typeLabel')}</label>
          ...
          <div className="flex gap-3 pt-4">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 px-4 py-2 border rounded-lg hover:bg-gray-50 dark:hover:bg-slate-800 dark:border-slate-700"
              disabled={loading}
            >
            ...
            <button
              type="submit"
              className="flex-1 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 disabled:bg-gray-400"
              disabled={loading}
            >
